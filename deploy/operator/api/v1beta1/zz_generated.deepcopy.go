...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DynamoComponentDeploymentService) DeepCopyInto(out *DynamoComponentDeploymentService) {
	*out = *in
	in.DynamoComponentDeploymentSharedSpec.DeepCopyInto(&out.DynamoComponentDeploymentSharedSpec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DynamoComponentDeploymentService.
func (in *DynamoComponentDeploymentService) DeepCopy() *DynamoComponentDeploymentService {
	if in == nil {
		return nil
	}
	out := new(DynamoComponentDeploymentService)
	in.DeepCopyInto(out)
	return out
}
...
func (in *DynamoGraphDeploymentSpec) DeepCopyInto(out *DynamoGraphDeploymentSpec) {
	*out = *in
	...
	if in.Services != nil {
		...
		*out = make([]DynamoComponentDeploymentService, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
